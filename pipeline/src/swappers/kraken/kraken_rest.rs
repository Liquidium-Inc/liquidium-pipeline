//! The live [`KrakenApi`] over `kraken_async_rs`.
//!
//! Everything that touches the wire is here: authentication, request
//! building, and the reading of Kraken's keyed responses. Nothing outside
//! this file sees a `kraken_async_rs` type.
...
use super::kraken_api::{
    KrakenApi, KrakenApiError, KrakenBook, KrakenBookLevel, KrakenDepositAddress, KrakenFundingMethod, KrakenOrder,
    KrakenOrderStatus, KrakenPair, KrakenTransferStatus, KrakenWithdrawal, KrakenWithdrawalAddress,
};
