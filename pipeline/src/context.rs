...
mod tests {
    ...
    fn test_config() -> Arc<Config> {
        ...
        Arc::new(Config {
            ...
            bridge_source_evm_address: "0x1111111111111111111111111111111111111111".to_string(),
            bridge_cketh_minter_canister: Principal::from_text("sv3dd-oaaaa-aaaar-qacoa-cai").expect("principal"),
            bridge_usdc_eth_token_address: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48".to_string(),
