...
// use liquidium_pipeline::swappers::mexc::mexc_adapter::MexcClient;
...
//     // Build ccxt adapter
//     let cex_client = Arc::new(MexcClient::new(&api_key, &api_secret));
...
//     let swapper = Arc::new(crate::swappers::mexc::mexc_swapper::MexcSwapVenue::new(
//         cex_client.clone(),
//     ));
